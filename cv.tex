...
Developed OpenCV based vision inspection applications for collaborative robotic material handling systems. Fortified existing vision applications for use in various lighting conditions. Implemented Ignition Designer SCADA applications.
